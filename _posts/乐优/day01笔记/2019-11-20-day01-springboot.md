...
![1525484756737](/images/leyou/1525484756737.png)
...
![1525485888078](/images/leyou/1525485888078.png)



工程名为demo：

 ![1525485977528](/images/leyou/1525485977528.png)

新建一个model：

 ![1525486079389](/images/leyou/1525486079389.png)

使用maven来构建：

![1525486188374](/images/leyou/1525486188374.png)

然后填写项目坐标：

 ![1525486236967](/images/leyou/1525486236967.png)

目录结构：

 ![1525486282929](/images/leyou/1525486282929.png)

项目结构：

 ![1525486435199](/images/leyou/1525486435199.png)
...
这个时候，我们会发现项目中多出了大量的依赖：
 ...
 ![1525486980765](/images/leyou/1525486980765.png)
...
Spring Boot项目通过main函数即可启动，我们需要创建一个启动类：
 ...
 ![1525487293907](/images/leyou/1525487293907.png)
...
我们编写一个controller：
 ...
 ![1525487465325](/images/leyou/1525487465325.png)
...
接下来，我们运行main函数，查看控制台：
 ...
 ![1525487613365](/images/leyou/1525487613365.png)

并且可以看到监听的端口信息：

 ![1525487705460](/images/leyou/1525487705460.png)
...
打开页面访问：http://localhost:8080/hello
 ...
 ![1525487820824](/images/leyou/1525487820824.png)
...
![1525492528558](/images/leyou/1525492528558.png)
...
- 需要注意的是，这里我们并没有指定属性文件的地址，所以我们需要把jdbc.properties名称改为application.properties，这是SpringBoot默认读取的属性文件名：
   ...
   ![1525496325572](/images/leyou/1525496325572.png)
...
![1525496543249](/images/leyou/1525496543249.png)
...
![1525497513206](/images/leyou/1525497513206.png)
...
一切魔力的开始，都是从我们的main函数来的，所以我们再次来看下启动类：
 ...
 ![1525488044650](/images/leyou/1525488044650.png)
...
![1525488226710](/images/leyou/1525488226710.png)
...
![1525488518514](/images/leyou/1525488518514.png)
...
我们跟进源码：
 ...
 ![1525498265579](/images/leyou/1525498265579.png)

并没有看到什么特殊的地方。我们查看注释：

 ![1525498351385](/images/leyou/1525498351385.png)
...
其实在我们的项目中，已经引入了一个依赖：spring-boot-autoconfigure，其中定义了大量自动配置类：
 ...
 ![1525499397690](/images/leyou/1525499397690.png)

还有：

 ![1525499426598](/images/leyou/1525499426598.png)
...
我们来看一个我们熟悉的，例如SpringMVC，查看mvc 的自动配置类：
 ...
 ![1525499859426](/images/leyou/1525499859426.png)

打开WebMvcAutoConfiguration：

![1525500000816](/images/leyou/1525500000816.png)
...
视图解析器：
 ...
 ![1525500405278](/images/leyou/1525500405278.png)

处理器适配器（HandlerAdapter）：

 ![1525500452517](/images/leyou/1525500452517.png)
...
![1525500697391](/images/leyou/1525500697391.png)

我们看到，这里通过@EnableAutoConfiguration注解引入了两个属性：WebMvcProperties和ResourceProperties。这不正是SpringBoot的属性注入玩法嘛。

我们查看这两个属性类：

 ![1525500810914](/images/leyou/1525500810914.png)

找到了内部资源视图解析器的prefix和suffix属性。

ResourceProperties中主要定义了静态资源（.js,.html,.css等)的路径：

 ![1525500921773](/images/leyou/1525500921773.png)
...
重启服务后测试：
 ...
 ![1525511878440](/images/leyou/1525511878440.png)
...
我们习惯会把静态资源放在`classpath:/static/`目录下。我们创建目录，并且添加一些静态资源：
 ...
 ![1525512196866](/images/leyou/1525512196866.png)

重启项目后测试：

 ![1525512253682](/images/leyou/1525512253682.png)
...
结构如下：
 ...
 ![1525513555179](/images/leyou/1525513555179.png)
...
其实，在刚才引入jdbc启动器的时候，SpringBoot已经自动帮我们引入了一个连接池：
 ...
 ![1525514424562](/images/leyou/1525514424562.png)

HikariCP应该是目前速度最快的连接池了，我们看看它与c3p0的对比：

 ![1525516441005](/images/leyou/1525516441005.png)
...
我们启动项目，查看：
 ...
 ![1525516714124](/images/leyou/1525516714124.png)
...
![1525517263421](/images/leyou/1525517263421.png)
...
SpringBoot会自动为Thymeleaf注册一个视图解析器：
 ...
 ![1525522481007](/images/leyou/1525522481007.png)

与解析JSP的InternalViewResolver类似，Thymeleaf也会根据前缀和后缀来确定模板文件的位置：

 ![1525522811359](/images/leyou/1525522811359.png)
...
根据上面的文档介绍，模板默认放在classpath下的templates文件夹，我们新建一个html文件放入其中：
 ...
 ![1525521721279](/images/leyou/1525521721279.png)
...
![1525523911854](/images/leyou/1525523911854.png)
